...
public class CadastroCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setFont(cpf.getFont());
        jButton1.setText("jButton1");

        jButton2.setFont(cpf.getFont());
        jButton2.setText("jButton1");

        id.setFont(jTextField1.getFont());
        id.setText("ID:");

        nome1.setFont(jTextField1.getFont());
        nome1.setText("Nome:");

        sexo.setFont(jTextField1.getFont());
        sexo.setText("Sexo:");

        cpf.setFont(jTextField1.getFont());
        cpf.setText("CPF:");

        email1.setFont(jTextField1.getFont());
        email1.setText("e-mail:");

        endereco.setFont(jTextField1.getFont());
        endereco.setText("Endereço:");

        telefone.setFont(jTextField1.getFont());
